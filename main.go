...
import (
	...
	"github.com/joshcarp/syslcatalog/templategeneration"
...
func main() {
	...
	templategeneration.NewProject(filename, output, plantumlService, logrus.New(), fs, m).GenerateMarkdownAndDiagrams()
}
